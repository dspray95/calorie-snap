...
//        }
     ...
     * @return
     */
    private Size chooseOptimalSize(List<Size> sizes, int w, int h) {
      ...
      Log.d("CameraActivity", "Using size: " + optimalSize.getWidth() + "w " + optimalSize.getHeight()+ "h");
        return optimalSize;
    }
    ...
    private void setUpCameraOutputs(int width, int height) {
        ...
        try {
            for (String cameraId : manager.getCameraIdList()) {
                ...
                mPreviewSize = chooseOptimalSize(Arrays.asList(map.getOutputSizes(SurfaceTexture.class)),
